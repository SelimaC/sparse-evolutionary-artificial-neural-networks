...
class FC_MLP:
    ...
    def fit(self, x, y_true, x_test, y_test, loss, epochs, batch_size, learning_rate=1e-3, momentum=0.9,
            weight_decay=0.0002, dropoutrate=0., testing=True, save_filename="", monitor=False):
        """
...
if __name__ == "__main__":
    ...
    for i in range(runs):
        ...
        dense_mlp = FC_MLP((x_train.shape[1], no_hidden_neurons_layer, no_hidden_neurons_layer, no_hidden_neurons_layer, y_train.shape[1]),
        ...
        dense_mlp.fit(x_train, y_train, x_test, y_test, loss=CrossEntropy, epochs=no_training_epochs, batch_size=batch_size, learning_rate=learning_rate,
                      ...
                      save_filename="../Results/fc_mlp_"+str(no_training_samples)+"_training_samples_rand"+str(i), monitor=True)
