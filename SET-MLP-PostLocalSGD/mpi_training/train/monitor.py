...
class Monitor(object):
    ...
    def __init__(self, sampling_rate=None, pid=None, save_filename=None):
        ...
        self.cpu_process = psutil.Process(self.pid)
    ...
    def _monitor(self):
        ...
        while not self.should_stop:
            ...
            try:
                ...
                cores = len(self.cpu_process.cpu_affinity())
            ...
            io_counters = self.cpu_process.io_counters()
            ...
            try:
                ...
                nice = int(self.cpu_process.nice())
            except psutil.AccessDenied:
                nice = 0

            # get the time the process was spawned
            try:
                create_time = datetime.fromtimestamp(self.cpu_process.create_time())
            except OSError:
