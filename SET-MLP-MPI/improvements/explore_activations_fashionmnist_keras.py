...
[noPar1, wm1] = createWeightsMask(20,28*28, 1000)
[noPar2, wm2] = createWeightsMask(20,1000, 1000)
[noPar3, wm3] = createWeightsMask(20,1000, 1000)

model = Sequential()
model.add(Flatten(input_shape=(28, 28)))
model.add(Dense(1000, name="sparse_1",kernel_constraint=MaskWeights(wm1),weights=w1))
...
model.add(Dropout(0.3))
model.add(Dense(1000, name="sparse_3",kernel_constraint=MaskWeights(wm3),weights=w3))
...
model.load_weights('fashionmnist_weights_fulltraining.h5')
...
np.savetxt("Weights1_fashionmnist.txt", weights[1])
weights[2] = model.get_layer("sparse_2").get_weights()[0]
np.savetxt("Weights2_fashionmnist.txt", weights[2])
weights[3] = model.get_layer("sparse_3").get_weights()[0]
np.savetxt("Weights3_fashionmnist.txt", weights[3])
weights[4] = model.get_layer("dense_4").get_weights()[0]
np.savetxt("Weights4_mnist.txt", weights[4])
b ={}
b[1] = model.get_layer("sparse_1").get_weights()[1]
np.savetxt("Biases1_fashionmnist.txt", b[1])
b[2] = model.get_layer("sparse_2").get_weights()[1]
np.savetxt("Biases2_fashionmnist.txt", b[2])
b[3] = model.get_layer("sparse_3").get_weights()[1]
np.savetxt("Biases3_fashionmnist.txt", b[3])
b[4] = model.get_layer("dense_4").get_weights()[1]
np.savetxt("Biases4_fashionmnist.txt", b[4])
srelu_weights = {}
srelu_weights[1] = np.loadtxt("SReluWeights1_fashionmnist.txt")
srelu_weights[2] = np.loadtxt("SReluWeights2_fashionmnist.txt")
srelu_weights[3] = np.loadtxt("SReluWeights3_fashionmnist.txt")
...
for k, w in weights.items():
    ...
    if k != 4:
        ...
        t2 = np.percentile(edges, 75)
        idxs = (-edges).argsort()[:500]
        print(
...
np.savetxt("Weights2_fashionmnist.txt", weights[2])
np.savetxt("Weights3_fashionmnist.txt", weights[3])
np.savetxt("Weights4_fashionmnist.txt", weights[4])
