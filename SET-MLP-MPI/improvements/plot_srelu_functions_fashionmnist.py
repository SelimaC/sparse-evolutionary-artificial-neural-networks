...
weights = {}
weights[1] = np.loadtxt("Weights1_fashionmnist.txt")
weights[2] = np.loadtxt("Weights2_fashionmnist.txt")
weights[3] = np.loadtxt("Weights3_fashionmnist.txt")
weights[4] = np.loadtxt("Weights4_fashionmnist.txt")
b = {}
b[1] = np.loadtxt("Biases1_fashionmnist.txt")
b[2] = np.loadtxt("Biases2_fashionmnist.txt")
b[3] = np.loadtxt("Biases3_fashionmnist.txt")
b[4] = np.loadtxt("Biases4_fashionmnist.txt")

srelu_weights_layer1 = np.loadtxt("SReluWeights1_fashionmnist.txt")
srelu_weights_layer2 = np.loadtxt("SReluWeights2_fashionmnist.txt")
srelu_weights_layer3 = np.loadtxt("SReluWeights3_fashionmnist.txt")
...
print("SReLu SET-MLP Keras version FASHIONMNIST dataset")
