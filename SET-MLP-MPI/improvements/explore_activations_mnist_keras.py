...
model.load_weights('mnist_weights_fulltraining.h5')
...
np.savetxt("Weights1_mnist.txt", weights[1])
weights[2] = model.get_layer("sparse_2").get_weights()[0]
np.savetxt("Weights2_mnist.txt", weights[2])
weights[3] = model.get_layer("sparse_3").get_weights()[0]
np.savetxt("Weights3_mnist.txt", weights[3])
...
np.savetxt("Biases1_mnist.txt", b[1])
b[2] = model.get_layer("sparse_2").get_weights()[1]
np.savetxt("Biases2_mnist.txt", b[2])
b[3] = model.get_layer("sparse_3").get_weights()[1]
np.savetxt("Biases3_mnist.txt", b[3])
b[4] = model.get_layer("dense_4").get_weights()[1]
np.savetxt("Biases4_mnist.txt", b[4])
srelu_weights = {}
srelu_weights[1] = np.loadtxt("SReluWeights1_mnist.txt")
srelu_weights[2] = np.loadtxt("SReluWeights2_mnist.txt")
srelu_weights[3] = np.loadtxt("SReluWeights3_mnist.txt")
