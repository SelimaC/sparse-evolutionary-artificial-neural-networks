...
weights = {}
weights[1] = np.loadtxt("Weights1_mnist.txt")
weights[2] = np.loadtxt("Weights2_mnist.txt")
weights[3] = np.loadtxt("Weights3_mnist.txt")
weights[4] = np.loadtxt("Weights4_mnist.txt")
b = {}
b[1] = np.loadtxt("Biases1_mnist.txt")
b[2] = np.loadtxt("Biases2_mnist.txt")
b[3] = np.loadtxt("Biases3_mnist.txt")
b[4] = np.loadtxt("Biases4_mnist.txt")

srelu_weights_layer1 = np.loadtxt("SReluWeights1_mnist.txt")
srelu_weights_layer2 = np.loadtxt("SReluWeights2_mnist.txt")
srelu_weights_layer3 = np.loadtxt("SReluWeights3_mnist.txt")
...
print("SReLu SET-MLP Keras version MNIST dataset")
