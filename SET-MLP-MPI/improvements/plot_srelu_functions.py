...
srelu_weights_layer1 = np.loadtxt("SReluWeights1_cifar10.txt")
srelu_weights_layer2 = np.loadtxt("SReluWeights2_cifar10.txt")
srelu_weights_layer3 = np.loadtxt("SReluWeights3_cifar10.txt")
